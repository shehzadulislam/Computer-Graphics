...
class cl_canvas_frame :
  def __init__( self, master ) :
    ...
    self.canvas = tk.Canvas(
      master.ob_root_window, width=560, height=400, bg='#99ff99' )
...
class cl_toolbar :
  def __init__( self, master ) :
    ...
    self.button = tk.Button( self.toolbar, text = 'ϕ', width = 8, command = self.toolbar_roll_callback )
    self.button.pack( side = tk.LEFT, padx = 2, pady = 2 )
    self.button = tk.Button( self.toolbar, text = 'θ', width = 8, command = self.toolbar_pitch_callback )
    self.button.pack( side = tk.LEFT, padx = 2, pady = 2 )
    self.button = tk.Button( self.toolbar, text = 'ψ', width = 8, command = self.toolbar_yaw_callback )
    self.button.pack( side = tk.LEFT, padx = 2, pady = 2 )
